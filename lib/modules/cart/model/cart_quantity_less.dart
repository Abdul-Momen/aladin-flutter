...
//
//     final cartQuantityLess = cartQuantityLessFromJson(jsonString);

import 'dart:convert';

CartQuantityLess cartQuantityLessFromJson(String str) => CartQuantityLess.fromJson(json.decode(str));

String cartQuantityLessToJson(CartQuantityLess data) => json.encode(data.toJson());

class CartQuantityLess {
  Data data;
  int code;
  String message;
  bool isSuccess;
  ...
  factory CartQuantityLess.fromJson(Map<String, dynamic> json) => CartQuantityLess(
