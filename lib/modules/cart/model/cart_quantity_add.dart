...
//
//     final cartQuantityAdd = cartQuantityAddFromJson(jsonString);

import 'dart:convert';

CartQuantityAdd cartQuantityAddFromJson(String str) => CartQuantityAdd.fromJson(json.decode(str));

String cartQuantityAddToJson(CartQuantityAdd data) => json.encode(data.toJson());

class CartQuantityAdd {
  Data data;
  int code;
  String message;
  bool isSuccess;
  ...
  factory CartQuantityAdd.fromJson(Map<String, dynamic> json) => CartQuantityAdd(
