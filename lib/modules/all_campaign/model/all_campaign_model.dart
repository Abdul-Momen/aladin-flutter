...
//
//     final allCanpaignModel = allCanpaignModelFromJson(jsonString);

import 'dart:convert';

AllCanpaignModel allCanpaignModelFromJson(String str) => AllCanpaignModel.fromJson(json.decode(str));

String allCanpaignModelToJson(AllCanpaignModel data) => json.encode(data.toJson());

class AllCanpaignModel {
  Data data;
  int code;
  String message;
  bool isSuccess;
  ...
  factory AllCanpaignModel.fromJson(Map<String, dynamic> json) => AllCanpaignModel(
