...
//
//     final allSoldOutModel = allSoldOutModelFromJson(jsonString);

import 'dart:convert';

AllSoldOutModel allSoldOutModelFromJson(String str) =>
    AllSoldOutModel.fromJson(json.decode(str));

String allSoldOutModelToJson(AllSoldOutModel data) =>
    json.encode(data.toJson());

class AllSoldOutModel {
  Data data;
  int code;
  String message;
  bool isSuccess;
  ...
  factory AllSoldOutModel.fromJson(Map<String, dynamic> json) =>
      AllSoldOutModel(
