...
//
//     final relatedListModel = relatedListModelFromJson(jsonString);

import 'dart:convert';

RelatedListModel relatedListModelFromJson(String str) =>
    RelatedListModel.fromJson(json.decode(str));

String relatedListModelToJson(RelatedListModel data) =>
...
class RelatedListModel {
  ...
  factory RelatedListModel.fromJson(Map<String, dynamic> json) =>
      RelatedListModel(
