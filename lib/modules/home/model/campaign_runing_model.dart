...
//
//     final campaignRuningModel = campaignRuningModelFromJson(jsonString);

import 'dart:convert';

CampaignRuningModel campaignRuningModelFromJson(String str) =>
    CampaignRuningModel.fromJson(json.decode(str));

String campaignRuningModelToJson(CampaignRuningModel data) =>
    json.encode(data.toJson());

class CampaignRuningModel {
  Data data;
  int code;
  String message;
  bool isSuccess;
  ...
  factory CampaignRuningModel.fromJson(Map<String, dynamic> json) =>
      CampaignRuningModel(
...
class Campaign {
  ...
  factory Campaign.fromJson(Map<String, dynamic> json) => Campaign(
        ...
        prizeForUae: List<PrizeFor>.from(
            json["prizeForUae"].map((x) => PrizeFor.fromJson(x))),
        prizeForIndia: List<PrizeFor>.from(
            json["prizeForIndia"].map((x) => PrizeFor.fromJson(x))),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "prizeForIndia":
            List<dynamic>.from(prizeForIndia.map((x) => x.toJson())),
      };
}
