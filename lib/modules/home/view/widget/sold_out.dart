...
class SoldOutItems extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    var percent = campaign
        .soldQty *
        1.0 /
        campaign
            .ticketQty;
   // var percent = campaign.productLimit * 1 / campaign.soldQty;
        ...
        child: Column(
          ...
          children: [
            Column(
              ...
              children: [
                Text(
                  "${campaign.soldQty} sold out of ${campaign.ticketQty}",
                  style: TextStyle(
            ...
            Stack(
              ...
              children: [
                Container(
                  ...
                  child: Stack(
                    children: [
                      Image.network(prizeImage,fit: BoxFit.fitHeight,),
