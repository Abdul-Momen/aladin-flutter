...
//
//     final recentListWishlistModel = recentListWishlistModelFromJson(jsonString);

import 'dart:convert';

RecentListWishlistModel recentListWishlistModelFromJson(String str) => RecentListWishlistModel.fromJson(json.decode(str));

String recentListWishlistModelToJson(RecentListWishlistModel data) => json.encode(data.toJson());

class RecentListWishlistModel {
  Data data;
  int code;
  String message;
  bool isSuccess;

  RecentListWishlistModel({
    required this.data,
    required this.code,
  ...
  factory RecentListWishlistModel.fromJson(Map<String, dynamic> json) => RecentListWishlistModel(
