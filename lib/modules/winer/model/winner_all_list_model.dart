...
//
//     final winnerAlllistModel = winnerAlllistModelFromJson(jsonString);

import 'dart:convert';

WinnerAlllistModel winnerAlllistModelFromJson(String str) => WinnerAlllistModel.fromJson(json.decode(str));

String winnerAlllistModelToJson(WinnerAlllistModel data) => json.encode(data.toJson());

class WinnerAlllistModel {
  Data data;
  int code;
  String message;
  bool isSuccess;
  ...
  factory WinnerAlllistModel.fromJson(Map<String, dynamic> json) => WinnerAlllistModel(
